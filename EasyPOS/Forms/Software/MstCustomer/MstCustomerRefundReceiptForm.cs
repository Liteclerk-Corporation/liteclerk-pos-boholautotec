...
{
    public partial class MstCustomerRefundReceiptForm : Form
    {
        public Int32 customerId = 0;
        public Entities.MstCustomerLoadEntity mstCustomerLoadEntity;

        public MstCustomerRefundReceiptForm(Int32 customerId_, Entities.MstCustomerLoadEntity customerLoadEntity)
        {
            InitializeComponent();
            ...
            {
                printDocumentRefundReceipt.DefaultPageSettings.PaperSize = new PaperSize("Official Receipt", 255, 38500);
                printDocumentRefundReceipt.Print();

            }
            else if (Modules.SysCurrentModule.GetCurrentSettings().PrinterType == "Thermal Printer")
            {
                printDocumentRefundReceipt.DefaultPageSettings.PaperSize = new PaperSize("Official Receipt", 280, 38500);
                printDocumentRefundReceipt.Print();
            }
            else
            {
                printDocumentRefundReceipt.DefaultPageSettings.PaperSize = new PaperSize("Official Receipt", 175, 38500);
                printDocumentRefundReceipt.Print();
            }
        }

        private void printDocumentRefundReceipt_PrintPage(object sender, PrintPageEventArgs e)
        {
            // ============
            // Data Context
            // ============
            ...
            // ======================
            String officialReceiptTitle = "R E F U N D";
