...
{
    public partial class MstCustomerWithdrawalReceiptForm : Form
    {
        public Int32 customerId = 0;
        public Entities.MstCustomerLoadEntity mstCustomerLoadEntity;

        public MstCustomerWithdrawalReceiptForm(Int32 customerId_, Entities.MstCustomerLoadEntity customerLoadEntity)
        {
            InitializeComponent();
            ...
            {
                printDocumentWithdrawalReceipt.DefaultPageSettings.PaperSize = new PaperSize("Official Receipt", 255, 38500);
                printDocumentWithdrawalReceipt.Print();

            }
            else if (Modules.SysCurrentModule.GetCurrentSettings().PrinterType == "Thermal Printer")
            {
                printDocumentWithdrawalReceipt.DefaultPageSettings.PaperSize = new PaperSize("Official Receipt", 280, 38500);
                printDocumentWithdrawalReceipt.Print();
            }
            else
            {
                printDocumentWithdrawalReceipt.DefaultPageSettings.PaperSize = new PaperSize("Official Receipt", 175, 38500);
                printDocumentWithdrawalReceipt.Print();
            }
        }

        private void printDocumentWithdrawalReceipt_PrintPage(object sender, PrintPageEventArgs e)
        {
            // ============
            // Data Context
            // ============
            ...
            // ======================
            String officialReceiptTitle = "LOAD WITHDRAWAL";
