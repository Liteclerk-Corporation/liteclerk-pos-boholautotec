...
{
    public partial class TrnPOSTouchSelectOrderTakerForm : Form
    {
        ...
        public TrnPOSTouchSelectOrderTakerForm(TrnPOSTouchForm POSTouchForm, TrnPOSTouchActivityForm POSTouchActivityForm, Entities.TrnSalesEntity salesEntity)
        {
            InitializeComponent();
