        ...
        private void printDocumentBarcodePrinting_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            switch (columns)
            {
                ...
                case 2:
                    ...
                    graphics.DrawString(itemAlias, fontCalibri6Bold, drawBrush, new RectangleF(x, y: 52, width, height), drawFormatCenter);
                    graphics.DrawString(itemAlias, fontCalibri6Bold, drawBrush, new RectangleF(x + 7 + width, y: 52, width, height), drawFormatCenter);
                    y += graphics.MeasureString(itemAlias, fontArial6Bold).Height * AdjustStringItemDescription;
                ...
                case 3:
                    ...
                    graphics.DrawString(itemAlias, fontCalibri6Bold, drawBrush, new RectangleF(x, y: 52, width, height), drawFormatCenter);
                    graphics.DrawString(itemAlias, fontCalibri6Bold, drawBrush, new RectangleF(x + 7 + width, y: 52, width, height), drawFormatCenter);
                    graphics.DrawString(itemAlias, fontCalibri6Bold, drawBrush, new RectangleF(x + 15 + width + width, y: 52, width, height), drawFormatCenter);
                    y += graphics.MeasureString(itemAlias, fontArial6Bold).Height * AdjustStringItemDescription;
