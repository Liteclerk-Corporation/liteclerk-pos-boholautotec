                        ...
                        else
                        {
                            if (sysUserRights.GetUserRights().CanView == true)
                            {
                                ...
                                if (sales.Any())
                                {
                                        ...
                                        if (readingAccNetSales.Any())
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        MessageBox.Show("Cannot proceed. Please generate " + minusDay.ToShortDateString(), "Liteclerk", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    {
                                        MessageBox.Show("Cannot proceed. No transactions below date " + firstSales.ToShortDateString(), "Liteclerk", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                    }
                                }
                                else
                                {
