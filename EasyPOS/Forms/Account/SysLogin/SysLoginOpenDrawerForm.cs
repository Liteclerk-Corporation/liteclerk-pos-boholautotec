    ...
    public partial class SysLoginOpenDrawerForm : Form
    {
        ...
        public void Authenticate()
        {
            ...
            if (user.Any())
            {
                ...
                {
                    MessageBox.Show("Not Authorized to Open Cash Drawer!", "Liteclerk", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
                MessageBox.Show("User doesn't exist!", "Liteclerk", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
